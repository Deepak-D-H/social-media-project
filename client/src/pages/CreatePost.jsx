  ...
  return (
    <div className='min-h-screen bg-linear-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        {/* Form */}
        <div className='max-w-xl bg-white p-4 sm:pb-3 rounded-xxl shadow-md space-y-4'>
          {/* Header */}
          ...
          <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
            ...
            <input type="file"  id='images' accept='image/*' hidden multiple onClick={(e)=>setImages([...images , ...e.target.files])}/>
