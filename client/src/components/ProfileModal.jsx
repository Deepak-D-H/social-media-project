...
const ProfileModal = ({ setShowEdit }) => {
  ...
  return (
    <div className='fixed w-full top-0 bottom-0 left-0 z-110 h-screen overflow-y-scroll bg-black/50'>
          ...
          <form className='space-y-4' onSubmit={handleSaveProfile}>
            ...
            <div className='flex flex-col items-start gap-3'>
              ...
              <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
                ...
                <div className='group/profile relative '>
                  ...
                  <div className='absolute w-24 h-24 hidden group-hover/profile:flex left-0  top-0 right-0 bottom-0 bg-black/20 rounded-full items-center justify-center'>
            ...
            <div className='flex justify-end space-x-3 pt-6'>
              ...
              onClick={()=>setShowEdit(false)}
               type='button' className='px-4 py-2 border border-gray-300 roundelg text-gray-700 hover:bg-gray-50 transition-colors cursor-pointer'>
                Cancel
              </button>
              <button
               type='submit' className='px-2 py-2 bg-linear-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition cursor-pointer '>
                Save Changes
              </button>
            </div>
