...
// used to see the stories of otherrs uploaded
  ...
  useEffect (()=>{
    ...
    if(viewStory && viewStory.media_type !=='video'){
      ...
      progressInterval = setInterval(() => {
        elapsed+=setTime;
        // {basically 10 incremented its related to width property in the style}
        setProgress((elapsed/duration)*100)
      }, setTime);

      // close the story  after duration (15 second)
      timer = setTimeout(()=>{
        setViewStory(null)
      },duration)
    }
