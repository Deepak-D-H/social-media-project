  ...
  return (
    <div className='relative py-4 px-6 md:px-8 bg-white'>
      <div className='flex flex-col md:flex-row items-start gap-6'>
        <div className='w-32 h-32 border-4 absolute border-white shadow-lg -top-16 rounded-full'>
        ...
        <div className='w-full pt-16 md:pt-0 md:pl-36 '>
          ...
          <div className='flex flex-wrap items-center gap-x-6 gap-y-6 text-sm text-gray-500 mt-4'>
